...
describe('SQL.ts Constants', () => {
  it('logLevelTable should contain SQL for creating log_level table', () => {
    ...
    expect(SQL.logLevelTable).toContain('id    integer constraint log_level_pk primary key');
